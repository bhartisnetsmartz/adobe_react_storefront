...
- Preview: https://main--adobe_react_storefront--bhartisnetsmartz.hlx.page/
- Live: https://main--adobe_react_storefront--bhartisnetsmartz.hlx.live/
...
1. Open the `adobe_react_storefront` directory in your favorite IDE and start coding :)
